...
public class HotTravelAroundAdapter extends BaseQuickAdapter<RecommendOther3Model.ObjBean, BaseViewHolder> {
    private Activity act;

    public HotTravelAroundAdapter(Activity act, @LayoutRes int layoutResId, @Nullable List<RecommendOther3Model.ObjBean> data) {
...
//                Intent intent = new Intent(act, TravelAroundDetailActivity.class);
