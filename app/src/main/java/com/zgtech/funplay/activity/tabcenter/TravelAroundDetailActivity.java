...
public class TravelAroundDetailActivity extends BaseActivity {
...
//    Button btnPin;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_travel_around_detail);
...
//        orderId = getIntent().getExtras().getString("orderId", "");
    ...
    public void initView() {
        ...
        initStatusBarState();
        tvRight.setBackgroundResource(R.drawable.ic_star_yellow_a200_24dp);
    }
    ...
    private void initPayModule() {
        mApiStores.initCharge(orderId).enqueue(new Callback<ChargeModel>() {
            ...
            private void handleServerData(ChargeModel body) {
                ...
                Pingpp.createPayment(TravelAroundDetailActivity.this, chargeJson);
            }
