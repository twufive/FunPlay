...
public class PinTuanRefundAdapter extends BaseQuickAdapter<PinTuanAllModel, BaseViewHolder> {
    private Activity act;

    public PinTuanRefundAdapter(Activity act, @LayoutRes int layoutResId, @Nullable List<PinTuanAllModel> data) {
