...
public class MyOrderAllAdapter extends BaseQuickAdapter<MyOrderModel.ObjBean, BaseViewHolder> {
    private Activity act;

    public MyOrderAllAdapter(Activity act, @LayoutRes int layoutResId, @Nullable List<MyOrderModel.ObjBean> data) {
