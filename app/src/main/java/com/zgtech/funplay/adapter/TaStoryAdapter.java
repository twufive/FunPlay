...
public class TaStoryAdapter extends BaseQuickAdapter<UserDetailModel.ObjBean.SpacesBean, BaseViewHolder> {
    private Activity context;

    public TaStoryAdapter(Activity context, int layoutResId, List<UserDetailModel.ObjBean.SpacesBean> data) {
    ...
    @Override
    protected void convert(BaseViewHolder helper, UserDetailModel.ObjBean.SpacesBean individualModel) {
    ...
    private void initImgsUI(BaseViewHolder helper, UserDetailModel.ObjBean.SpacesBean individuallModel, List<String> imgUrlList) {
