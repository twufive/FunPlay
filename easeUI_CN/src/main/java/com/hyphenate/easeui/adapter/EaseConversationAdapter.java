...
public class EaseConversationAdapter extends ArrayAdapter<EMConversation> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (holder == null) {
            ...
            holder.group_avatar = (RelativeLayout) convertView.findViewById(R.id.group_avatar);
        ...
        if (conversation.getType() == EMConversationType.GroupChat) {
            ...
            // TODO: 2017/7/10 群聊头像核心代码修改
//            Glide.with(getContext())
//                    .load("")
//                    .into(holder.avatar);
//            holder.avatar.setImageResource(R.drawable.ease_group_icon);

            EaseUserUtils.setGroupAvatar(getContext(), username, holder.group_avatar);
            EaseUserUtils.setGroupNick(username, holder.name);
